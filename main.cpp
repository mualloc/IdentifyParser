...
void PrintIdentifyDeviceData(std::unique_ptr<IdentifyDeviceData> identify_device_data)
{
...
int main(int argc, char** argv)
{
	...
	auto identify_parser = std::make_unique<IdentifyParser>(input_file_name);
